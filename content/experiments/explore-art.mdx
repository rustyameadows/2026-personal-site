...
export const experiment = {
  ...
  title: "Explore Art",
  description:
    "Explore Art lets people search across public art collections by natural language, exact color, visual similarity, selected details, and conversation—while keeping every result connected to its source and rights evidence.",
  ...
  items={[
    {
      label: "Role",
      value:
        "Concept, product strategy, interaction and visual design, full-stack engineering, multimodal retrieval, data and ingestion architecture, evaluation, research, and deployment"
    },
    {
      label: "Timeline",
      value: "Approximately two weeks of concentrated initial development, ongoing"
    },
    { label: "Status", value: "Live V0 experiment" }
  ]}
/>
...
<CaseStudyFigure placeholder="panoramaLight" />
...
<CaseStudyFigure placeholder="landscapeMid" />
...
<CaseStudyFigure placeholder="wideLight" />
...
<CaseStudyFigure placeholder="bannerLight" />
...
<CaseStudyFigure placeholder="portraitMid" />
